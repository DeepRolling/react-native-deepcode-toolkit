...
function AnimationedPopUp(props: {children: any; style?: StyleProp<ViewStyle>}, ref: any) {
    const opaqueAnimationValue = useRef<Animated.Value>(new Animated.Value(0)).current;
...
export default React.forwardRef(AnimationedPopUp);
