...
export function RootContainer(props: {children: any; backgroundColor?: string; needAutoPadding?: boolean}) {
    const {
        colorTheme: {ui},
    } = useColorTheme();
    ...
    return (
        <View
            style={{
                flex: 1,
                backgroundColor: props.backgroundColor ? props.backgroundColor : ui.backgroundColor,
            ...
            <View style={{width: '100%', height: '100%', backgroundColor: props.backgroundColor ? props.backgroundColor : ui.backgroundColor}}>
                {props.children}
            </View>
        </View>
    );
